...
st.caption("จัดทำโดย นายมาหะมะ กาลาแต — รหัสนักศึกษา 6910120019")
...
st.caption("Powered by Apache Airflow · PostgreSQL · Streamlit — จัดทำโดย นายมาหะมะ กาลาแต (6910120019)")
